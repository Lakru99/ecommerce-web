package com.aqurumedia.ecom.order.domain.user.service;

import com.aqurumedia.ecom.order.domain.user.aggregate.User;
import com.aqurumedia.ecom.order.domain.user.repository.UserRepository;
import com.aqurumedia.ecom.order.infrastructure.secondary.service.kinde.KindeService;
import com.aqurumedia.ecom.shared.authentication.application.AuthenticatedUser;
...
public class UserSynchronizer {
  ...
  private void updateUser(User user, User user1) {
